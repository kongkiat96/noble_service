...
@section('content')
    ...
    <div class="modal fade" id="addWorkerModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">

        </div>
    </div>

    <div class="modal fade" id="editWorkerModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
                ...
                <ul class="nav nav-pills mb-3" role="tablist">
                    <li class="nav-item">
                        <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
                            data-bs-target="#worker-list" aria-controls="#worker-list" aria-selected="true" id="reTabA">
                            ข้อมูลรายการผู้ปฏิบัติงาน
                        </button>
                    </li>
                </ul>

                <div class="tab-content">
                    <div class="tab-pane fade show active" id="worker-list" role="tabpanel">
                        <div class="inline-spacing text-end">
                            @if (Auth::user()->user_system != 'Viewer')
                                <button type="button" class="btn btn-info" id="addWorker">
                                    <i class='menu-icon tf-icons bx bx-street-view'></i> เพิ่มข้อมูลรายการผู้ปฏิบัติงาน
                                </button>
                            @endif
                        </div>
