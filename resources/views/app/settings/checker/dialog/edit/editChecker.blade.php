                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="use_tag" name="use_tag" class="form-select select2" data-allow-clear="true">
                            ...
                            <option value="it" @if ($dataChecker->use_tag == 'it') selected @endif>ใช้งานเฉพาะ ICT</option>
                            <option value="mt" @if ($dataChecker->use_tag == 'mt') selected @endif>ใช้งานเฉพาะ CMM</option>
