<div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title">เพิ่มข้อมูลรายการประเภทสินทรัพย์</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <hr>
    <div class="modal-body pt-0">
        <div class="row g-1">
            <form id="formAddAssetTag" class="form-block">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label-md mb-2" for="asset_tag_name">รายการสินทรัพย์</label>
                        <input type="text" id="asset_tag_name" class="form-control" name="asset_tag_name" autocomplete="off" />
                    </div>
    
                    <div class="col-md-6 mb-3">
                        <label class="form-label-md mb-2" for="asset_tag_color">สีรายการสินทรัพย์</label>
                        <input type="color" id="asset_tag_color" class="form-control" style="height: 40px" name="asset_tag_color" autocomplete="off" />
                    </div>
                </div>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" name="saveAssetTag" id="saveAssetTag" class="btn btn-success btn-form-block-overlay"><i
