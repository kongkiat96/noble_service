<div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title">แก้ไขข้อมูลรายการประเภทสินทรัพย์</h5>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-label-danger" data-bs-dismiss="modal"><i
            ...
            <input type="hidden" name="assetTagID" id="assetTagID" value="{{ $getDataAssetTag->id }}">
        <button type="submit" name="saveEditAssetTag" id="saveEditAssetTag" class="btn btn-warning btn-form-block-overlay"><i
                class='menu-icon tf-icons bx bxs-save'></i>
            บันทึกข้อมูล</button>
    </div>

    <script type="text/javascript"
        src="{{ asset('/assets/custom/assetsManagement/settingsAsset/func_edit.js?v=') }}@php echo date("H:i:s") @endphp">
    </script>
