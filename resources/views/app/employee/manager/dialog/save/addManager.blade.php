<div class="modal-content">
            ...
            <form>
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" id="class_name" class="form-control" name="class_name" autocomplete="off"
                            readonly />
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" id="group_name" class="form-control" name="group_name" autocomplete="off"
                            readonly />
                    </div>
    ...
    <script type="text/javascript"
        src="{{ asset('/assets/custom/employee/manager/func_save.js?v=') }}@php echo date("H:i:s") @endphp"></script>
