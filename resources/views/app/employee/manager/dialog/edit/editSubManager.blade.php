<div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title">แก้ไขข้อมูลผู้ใต้บังคับบัญชา</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <hr>
    <div class="modal-body pt-0">
        <div class="row g-1">
            <form id="formEditSubManager" class="form-block">
                <div class="row">
                    <div class="col-md-6">
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-label-danger" data-bs-dismiss="modal"><i
            ...
            <input type="text" name="subManagerID" id="subManagerID" value="{{ $dataManager->id }}" hidden>
        <button type="submit" name="saveEditSubManager" id="saveEditSubManager" class="btn btn-warning btn-form-block-overlay"><i
