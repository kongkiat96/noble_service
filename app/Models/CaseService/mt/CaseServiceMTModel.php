...
namespace App\Models\CaseService\mt;
...
class CaseServiceMTModel extends Model
{
    use HasFactory;
    ...
    public function getDataCaseWaitApproveMT($param)
    {
        try {
            $sql = DB::connection('mysql')->table('tbt_case_service AS cs')
                ...
                ->where('cs.use_tag', 'MT')->where('cs.tag_work', 'wait_manager_mt_approve');
    ...
    public function getDataCaseOpenMT($param)
    {
        try {
            $sql = DB::connection('mysql')->table('tbt_case_service AS cs')
                // ->where(function ($query) use ($param) {
    ...
    public function getDataCaseDoingMT($param)
    {
        try {
            $sql = DB::connection('mysql')->table('tbt_case_service AS cs')
                // ->where(function ($query) use ($param) {
    ...
    public function getDataCaseSuccessMT($param)
    {
        try {
            $sql = DB::connection('mysql')->table('tbt_case_service AS cs')
                // ->where(function ($query) use ($param) {
